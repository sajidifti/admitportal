...
<div class="max-w-xl mx-auto bg-white p-8 rounded shadow">
    ...
    <form action="{{ route('admit.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name_bn" value="{{ old('name_bn') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400">
            @error('name_bn')
        ...
        <div>
            ...
            <input type="text" name="father_name_bn" value="{{ old('father_name_bn') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400">
        ...
        <div>
            ...
            <input type="text" name="mother_name_bn" value="{{ old('mother_name_bn') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400">
        ...
        <div>
            ...
            <input type="text" name="school" value="{{ old('school') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400">
            @error('school')
                <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="date" name="exam_date" value="{{ old('exam_date') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400">
            @error('exam_date')
                <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="roll" value="{{ old('roll') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400">
            @error('roll')
                <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="exam_center_bn" value="{{ old('exam_center_bn') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400">
        ...
        <div>
            ...
            <input type="text" name="exam_time" value="{{ old('exam_time') }}" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-400">
            @error('exam_time')
                <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="flex items-center justify-between pt-4">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded">Save</button>
